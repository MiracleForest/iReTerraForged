...
public record StrataRule(ResourceLocation cacheId, int buffer, int iterations, Holder<Noise> selector,
                         List<Layer> layers) implements SurfaceRules.RuleSource {
...
//				}
    ...
    public record Layer(TagKey<Block> materials, Holder<Noise> depth, int attempts, int minLayers, int maxLayers,
