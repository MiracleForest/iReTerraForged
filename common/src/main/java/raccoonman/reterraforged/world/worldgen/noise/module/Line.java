...
public record Line(float x1, float z1, float x2, float z2, Noise radiusSq, Noise fadeIn, Noise fadeOut, float feather,
                   float featherBias, float orthX1, float orthZ1, float orthX2, float orthZ2, float dx, float dz,
                   float lengthSq) implements Noise {
