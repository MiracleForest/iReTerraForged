...
public record DecoratorConfig<T extends TemplateContext>(List<TemplateDecorator<T>> defaultDecorators,
                                                         Map<ResourceKey<Biome>, List<TemplateDecorator<T>>> biomeDecorators) {
